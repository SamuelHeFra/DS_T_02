        ...
        <section className={`${styles.hero} ${styles.section}`} id="home">
            <div className={`${styles.hero__container} ${styles.container}`}>
                <div className={styles.hero__content}>
                    ...
                    <h1 className={styles.hero__title}>Samuel Herrera Franco</h1>
                    ...
                    <p className={styles.hero__description}>
                        ...
                        enfoque orientado aa resultados para transformar ideas en código funcional.
                    </p>
                    <div className={styles.hero__buttons}>
                        <Link href="#projects" className={`${styles.btn} ${styles['btn--outline']}`}>
                            <i className={`${styles.fas} ${styles['fa-rocket']}`}></i> Ver mis proyectos
                        </Link>
                        <Link href="#contact" className={`${styles.btn} ${styles['btn--outline']}`}>
                            <i className={`${styles.fas} ${styles['fa-envelope']}`}></i> Contáctame
                        </Link>
                    </div>
                </div>
                ...
                <div className={styles.hero__image}>
                    <div className={styles.hero__blob}>
                        <div className={styles.hero__avatar}>
                            <i className={`${styles.fas} ${styles['fa-user-astronaut']}`}></i>
                        </div>
                    </div>
            ...
            <div className={styles.hero__scroll}>
                <Link href="#interests" className={styles['hero__scroll-link']}>
                    <span>Scroll</span>
                    <i className={`${styles.fas} ${styles['fa-chevron-down']}`}></i>
                </Link>
            </div>
        </section>
        </>
